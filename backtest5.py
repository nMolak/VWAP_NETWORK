...
def backtest(
    ...
    with open(log_txt, "w", encoding="utf-8") as f:
        ...
        f.write(
            f"# Parametry: sigma={summary['params']['sigma_mult']}, T={T}, alpha={alpha}, use_atr={use_atr}, leverage={leverage}\n")
        ...
        for _, r in trades_df.iterrows():
            f.write(
                ...
                f"EXIT  {r['exit_time']} | reason={r['exit_reason']} | price={r['exit_price']:.4f} | Δ%_price={r['ret_price'] * 100:+.2f}% | Δ%_signed={r['signed_ret_price'] * 100:+.2f}% | bars={r['bars_held']}\n"
